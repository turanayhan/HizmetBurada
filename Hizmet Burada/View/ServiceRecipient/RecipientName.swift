...
class RecipientName: UIViewController {
    ...
    lazy var nameSurnameText2:UITextView = {
        let infoText = UITextView()
        infoText.text = "Hizmet sağlayıcılar, profilinizde ve teklif mesajlarınızda adınızı görecekler."
        infoText.textColor = .black
        infoText.textAlignment = .center
        infoText.backgroundColor = .clear
    ...
    func desing(){
        ...
        nameSurnameText2.anchor(top: nameSurnameText.bottomAnchor,
                                ...
                                padding: .init(top: 0, left: 12, bottom: 0,
                                               right: 12),size: .init(width: 0, height: 80))
    ...
    @objc func nextButtonTapped(click : UIButton!) {
        ...
        navigationController?.pushViewController(RecipientGsm(), animated: true)
    }
